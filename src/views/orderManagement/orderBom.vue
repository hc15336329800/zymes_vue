  ...
  <div class="w_100 pt_30 plr_30 ptb_30">
    <el-row>
      <el-col :xs="6" :sm="6" :lg="6" class="flex_row flex_shink ptb_10 plr_10">
        ...
        <div class="ml_10">{{ detail.bomNo }}</div>
      </el-col>
      <el-col :xs="6" :sm="6" :lg="6" class="flex_row flex_shink ptb_10 plr_10">
        <div class="label fw_bold fs_24">BOM名称</div>
        <div class="ml_10">{{ detail.itemName }}</div>
      </el-col>
      <el-col :xs="6" :sm="6" :lg="6" class="flex_row flex_shink ptb_10 plr_10">
        <div class="label fw_bold fs_24">计量单位</div>
        <div class="ml_10">{{ detail.itemMeasure }}</div>
      </el-col>
      <el-col :xs="6" :sm="6" :lg="6" class="flex_row flex_shink ptb_10 plr_10">
        <div class="label fw_bold fs_24">库存量</div>
        <div class="ml_10">{{ detail.itemCount }}</div>
      </el-col>
    </el-row>
    <el-row>
      <el-col :xs="6" :sm="6" :lg="6" class="flex_row flex_shink ptb_10 plr_10">
        <div class="label fw_bold fs_24">产品编码</div>
        <div class="ml_10">{{ detail.itemNo }}</div>
      </el-col>
      <el-col :xs="6" :sm="6" :lg="6" class="flex_row flex_shink ptb_10 plr_10">
        <div class="label fw_bold fs_24">规格型号</div>
        <div class="ml_10">{{ detail.itemModel }}</div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="12" class="flex_row flex_shink ptb_10 plr_10">
        <div class="label fw_bold fs_24">库位</div>
        <div class="ml_10">{{ detail.location }}</div>
      </el-col>
    </el-row>
          ...
          case 3: // 返回
            this.$router.push({
              ...
              query: {
                ...
                info: JSON.stringify(this.orderInfo)
              }
            })
            break
          case 4: // 新增一行工序分配
